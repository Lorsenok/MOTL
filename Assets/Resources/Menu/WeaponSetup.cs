...
public class WeaponSetup : MonoBehaviour
{
    ...
    public void SetToDefault()
    {
        ...
        redInputField.text = WeaponData.LaserColorDefault.r.ToString();
        greenInputField.text = WeaponData.LaserColorDefault.g.ToString();
        blueInputField.text = WeaponData.LaserColorDefault.b.ToString();
    }
